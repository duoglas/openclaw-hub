---
title: "OpenClaw Daily: Practical Agent Automation Tips (2026-02-16)"
...
│ Channel         │ dev (main)                                                                                        │
│ Git             │ main · @ dec68597                                                                                 │
│ Update          │ available · git main · ↔ origin/main · behind 68 · fetch failed · npm update 2026.2.14 · deps ok  │
...
│ Gateway service │ systemd installed · enabled · running (pid 3649357, state active)                                 │
...
│ Sessions        │ 10 active · default claude-opus-4-6 (200k ctx) · ~/.openclaw/agents/main/sessions/sessions.json   │
└─────────────────┴───────────────────────────────────────────────────────────────────────────────────────────────────┘
...
│ agent:main:cron:fdc137d1-c50d-4…                          │ direct │ 1h ago   │ claude-opus-4-6 │ 28k/200k (14%)    │
│ agent:main:cron:fdc137d1-c50d-4…                          │ direct │ 1h ago   │ claude-opus-4-6 │ 28k/200k (14%)    │
│ agent:main:cron:413049b3-4e80-4…                          │ direct │ 23h ago  │ claude-opus-4-6 │ 40k/200k (20%)    │
│ agent:main:cron:413049b3-4e80-4…                          │ direct │ 23h ago  │ claude-opus-4-6 │ 40k/200k (20%)    │
│ agent:main:cron:6c56f30e-31bf-4…                          │ direct │ 24h ago  │ claude-opus-4-6 │ 18k/200k (9%)     │
│ agent:main:subagent:63fd7e14-61…                          │ direct │ 6d ago   │ gpt-5.3-codex   │ 6.1k/272k (2%)    │
│ agent:main:wecom:group:wr071dya…                          │ group  │ 11d ago  │ MiniMax-M2.1    │ 13k/200k (7%)     │
└───────────────────────────────────────────────────────────┴────────┴──────────┴─────────────────┴───────────────────┘
...
│ Item     │ Status    │ Detail                                                                                       │
├──────────┼───────────┼──────────────────────────────────────────────────────────────────────────────────────────────┤
│ Gateway  │ reachable │ 4379ms                                                                                       │
│ Telegram │ OK        │ ok (@djclawd_bot:default:3337ms)                                                             │
...
Update available (git behind 68 · npm 2026.2.14). Run: openclaw update
