---
title: "OpenClaw Daily: Practical Agent Automation Tips (2026-02-21)"
...
│ Channel         │ dev (main)                                                                                        │
│ Git             │ main · @ 0f1b2ad9                                                                                 │
│ Update          │ available · git main · ↔ origin/main · behind 5 · npm latest 2026.2.19-2 (local newer) · deps ok  │
│ Gateway         │ local · ws://127.0.0.1:18789 (local loopback) · reachable 26ms · auth token · duoglas-VMware-     │
│                 │ Virtual-Platform (192.168.136.128) app unknown linux 6.14.0-37-generic                            │
│ Gateway service │ systemd installed · enabled · running (pid 2731775, state active)                                 │
│ Node service    │ systemd not installed                                                                             │
│ Agents          │ 1 · no bootstraps · sessions 15 · default main active just now                                    │
│ Memory          │ 0 files · 0 chunks · dirty · sources memory · plugin memory-core · vector ready · fts ready ·     │
│                 │ cache on (0)                                                                                      │
│ Probes          │ enabled                                                                                           │
│ Events          │ none                                                                                              │
│ Heartbeat       │ 1h (main)                                                                                         │
│ Last heartbeat  │ ok-token · 7m ago ago · telegram · account default                                                │
│ Sessions        │ 15 active · default claude-opus-4-6 (200k ctx) · ~/.openclaw/agents/main/sessions/sessions.json   │
└─────────────────┴───────────────────────────────────────────────────────────────────────────────────────────────────┘
...
│ agent:main:cron:6c56f30e-31bf-4…                        │ direct │ just now │ claude-opus-4-6   │ unknown/200k (?%) │
│ agent:main:main                                         │ direct │ 7m ago   │ claude-opus-4-6   │ 80k/200k (40%)    │
│ agent:main:subagent:de649473-b4…                        │ direct │ 52m ago  │ claude-sonnet-4-5 │ 43k/200k (22%)    │
│ agent:main:cron:fdc137d1-c50d-4…                        │ direct │ 1h ago   │ claude-opus-4-6   │ 26k/200k (13%)    │
│ agent:main:cron:fdc137d1-c50d-4…                        │ direct │ 1h ago   │ claude-opus-4-6   │ 26k/200k (13%)    │
│ agent:main:cron:fdc137d1-c50d-4…                        │ direct │ 1h ago   │ claude-opus-4-6   │ 24k/200k (12%)    │
│ agent:main:cron:413049b3-4e80-4…                        │ direct │ 23h ago  │ claude-opus-4-6   │ 26k/200k (13%)    │
│ agent:main:cron:413049b3-4e80-4…                        │ direct │ 23h ago  │ claude-opus-4-6   │ 26k/200k (13%)    │
...
│ Item     │ Status    │ Detail                                                                                       │
├──────────┼───────────┼──────────────────────────────────────────────────────────────────────────────────────────────┤
│ Gateway  │ reachable │ 3754ms                                                                                       │
│ Telegram │ OK        │ ok (@djclawd_bot:default:2628ms)                                                             │
│ Slack    │ OK        │ ok (default:default:1126ms)                                                                  │
...
Update available (git behind 5). Run: openclaw update
