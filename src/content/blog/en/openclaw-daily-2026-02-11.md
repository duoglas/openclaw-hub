---
title: "OpenClaw Daily: Practical Agent Automation Tips (2026-02-11)"
...
│ Gateway         │ local · ws://127.0.0.1:18789 (local loopback) · reachable 35ms · auth token · duoglas-VMware-     │
│                 │ Virtual-Platform (192.168.136.128) app unknown linux 6.14.0-37-generic                            │
│ Gateway service │ systemd installed · enabled · running (pid 56052, state active)                                   │
...
│ Events          │ none                                                                                              │
│ Heartbeat       │ 1h (main)                                                                                         │
│ Last heartbeat  │ ok-token · 13m ago ago · telegram · account default                                               │
...
├────────────────────────────────────────────────────────────┼────────┼──────────┼─────────────────┼──────────────────┤
│ agent:main:cron:6c56f30e-31bf-4…                           │ direct │ just now │ gpt-5.3-codex   │ 0.0k/272k (0%)   │
│ agent:main:cron:6c56f30e-31bf-4…                           │ direct │ just now │ gpt-5.3-codex   │ 0.0k/272k (0%)   │
│ agent:main:main                                            │ direct │ 13m ago  │ claude-opus-4-6 │ 28k/200k (14%)   │
│ agent:main:cron:fdc137d1-c50d-4…                           │ direct │ 1h ago   │ claude-opus-4-6 │ 200k/200k (100%) │
│ agent:main:cron:fdc137d1-c50d-4…                           │ direct │ 1h ago   │ claude-opus-4-6 │ 200k/200k (100%) │
│ agent:main:cron:6c56f30e-31bf-4…                           │ direct │ 17h ago  │ gpt-5.3-codex   │ 83k/272k (31%)   │
│ agent:main:subagent:63fd7e14-61…                           │ direct │ 19h ago  │ gpt-5.3-codex   │ 6.1k/272k (2%)   │
│ agent:main:wecom:group:wr071dya…                           │ group  │ 6d ago   │ MiniMax-M2.1    │ 13k/200k (7%)    │
└────────────────────────────────────────────────────────────┴────────┴──────────┴─────────────────┴──────────────────┘
...
│ Item     │ Status    │ Detail                                                                                       │
├──────────┼───────────┼──────────────────────────────────────────────────────────────────────────────────────────────┤
│ Gateway  │ reachable │ 3543ms                                                                                       │
│ Telegram │ OK        │ ok (@djclawd_bot:default:2574ms)                                                             │
│ Slack    │ OK        │ ok (default:default:968ms)                                                                   │
