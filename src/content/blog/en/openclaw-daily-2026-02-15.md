...
description: "Channel reliability notes for OpenClaw covering status checks, upgrade drift, and openclaw telegram getupdates conflict 409 recovery steps."
pubDate: 2026-02-15
...
│ Channel         │ dev (main)                                                                                        │
│ Git             │ main · @ dec68597                                                                                 │
│ Update          │ available · git main · ↔ origin/main · behind 68 · npm latest 2026.2.13 · deps ok                 │
...
│ Gateway service │ systemd installed · enabled · running (pid 3165745, state active)                                 │
...
│ Events          │ none                                                                                              │
│ Heartbeat       │ 1h (main)                                                                                         │
│ Last heartbeat  │ ok-token · 5m ago ago · telegram · account default                                                │
...
│ agent:main:cron:6c56f30e-31bf-4…                          │ direct │ just now │ claude-opus-4-6 │ unknown/200k (?%) │
│ agent:main:main                                           │ direct │ 5m ago   │ claude-opus-4-6 │ 46k/200k (23%)    │
│ agent:main:cron:fdc137d1-c50d-4…                          │ direct │ 1h ago   │ claude-opus-4-6 │ 200k/200k (100%)  │
│ agent:main:cron:fdc137d1-c50d-4…                          │ direct │ 1h ago   │ claude-opus-4-6 │ 200k/200k (100%)  │
│ agent:main:cron:6c56f30e-31bf-4…                          │ direct │ 24h ago  │ claude-opus-4-6 │ 120k/200k (60%)   │
│ agent:main:subagent:63fd7e14-61…                          │ direct │ 5d ago   │ gpt-5.3-codex   │ 6.1k/272k (2%)    │
│ agent:main:wecom:group:wr071dya…                          │ group  │ 10d ago  │ MiniMax-M2.1    │ 13k/200k (7%)     │
└───────────────────────────────────────────────────────────┴────────┴──────────┴─────────────────┴───────────────────┘
...
│ Item     │ Status    │ Detail                                                                                       │
├──────────┼───────────┼──────────────────────────────────────────────────────────────────────────────────────────────┤
│ Gateway  │ reachable │ 3873ms                                                                                       │
│ Telegram │ OK        │ ok (@djclawd_bot:default:2846ms)                                                             │
│ Slack    │ OK        │ ok (default:default:1026ms)                                                                  │
