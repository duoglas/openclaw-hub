---
title: "OpenClaw Daily: Practical Agent Automation Tips (2026-02-10)"
...
│ Channel         │ dev (main)                                                                                        │
│ Git             │ main · @ e7f0769c                                                                                 │
│ Update          │ available · git main · ↔ origin/main · behind 7 · npm latest 2026.2.9 · deps ok                   │
│ Gateway         │ local · ws://127.0.0.1:18789 (local loopback) · reachable 34ms · auth token · duoglas-VMware-     │
│                 │ Virtual-Platform (192.168.136.128) app unknown linux 6.14.0-37-generic                            │
│ Gateway service │ systemd installed · enabled · running (pid 1591, state active)                                    │
...
│ Events          │ none                                                                                              │
│ Heartbeat       │ 1h (main)                                                                                         │
│ Last heartbeat  │ ok-token · 32m ago ago · slack · account default                                                  │
│ Sessions        │ 5 active · default claude-opus-4-6 (200k ctx) · ~/.openclaw/agents/main/sessions/sessions.json    │
└─────────────────┴───────────────────────────────────────────────────────────────────────────────────────────────────┘
...
│ agent:main:cron:6c56f30e-31bf-4…                            │ direct │ just now │ claude-opus-4-6 │ 0.0k/200k (0%)  │
│ agent:main:main                                             │ direct │ 1m ago   │ gpt-5.3-codex   │ 147k/272k (54%) │
│ agent:main:subagent:63fd7e14-61…                            │ direct │ 2h ago   │ gpt-5.3-codex   │ 6.1k/272k (2%)  │
│ agent:main:wecom:group:wr071dya…                            │ group  │ 5d ago   │ MiniMax-M2.1    │ 13k/200k (7%)   │
└─────────────────────────────────────────────────────────────┴────────┴──────────┴─────────────────┴─────────────────┘
...
│ Item     │ Status    │ Detail                                                                                       │
├──────────┼───────────┼──────────────────────────────────────────────────────────────────────────────────────────────┤
│ Gateway  │ reachable │ 3892ms                                                                                       │
│ Telegram │ OK        │ ok (@djclawd_bot:default:2833ms)                                                             │
│ Slack    │ OK        │ ok (default:default:1057ms)                                                                  │
...
Update available (git behind 7). Run: openclaw update
