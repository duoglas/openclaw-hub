---
title: "OpenClaw Daily: Practical Agent Automation Tips (2026-02-14)"
...
│ Channel         │ dev (main)                                                                                        │
│ Git             │ main · @ e7f0769c                                                                                 │
│ Update          │ available · git main · ↔ origin/main · behind 16 · fetch failed · npm update 2026.2.12 · deps ok  │
...
│ Events          │ none                                                                                              │
│ Heartbeat       │ 1h (main)                                                                                         │
│ Last heartbeat  │ ok-token · 14m ago ago · telegram · account default                                               │
...
│ agent:main:cron:6c56f30e-31bf-4…                           │ direct │ just now │ claude-opus-4-6 │ 0.0k/200k (0%)   │
│ agent:main:main                                            │ direct │ 14m ago  │ claude-opus-4-6 │ 61k/200k (31%)   │
│ agent:main:cron:fdc137d1-c50d-4…                           │ direct │ 1h ago   │ claude-opus-4-6 │ 200k/200k (100%) │
│ agent:main:cron:fdc137d1-c50d-4…                           │ direct │ 1h ago   │ claude-opus-4-6 │ 200k/200k (100%) │
│ agent:main:cron:6c56f30e-31bf-4…                           │ direct │ 24h ago  │ claude-opus-4-6 │ 102k/200k (51%)  │
│ agent:main:subagent:63fd7e14-61…                           │ direct │ 4d ago   │ gpt-5.3-codex   │ 6.1k/272k (2%)   │
│ agent:main:wecom:group:wr071dya…                           │ group  │ 9d ago   │ MiniMax-M2.1    │ 13k/200k (7%)    │
└────────────────────────────────────────────────────────────┴────────┴──────────┴─────────────────┴──────────────────┘
...
│ Item     │ Status    │ Detail                                                                                       │
├──────────┼───────────┼──────────────────────────────────────────────────────────────────────────────────────────────┤
│ Gateway  │ reachable │ 3750ms                                                                                       │
│ Telegram │ OK        │ ok (@djclawd_bot:default:2652ms)                                                             │
│ Slack    │ OK        │ ok (default:default:1098ms)                                                                  │
...
Update available (git behind 16 · npm 2026.2.12). Run: openclaw update
