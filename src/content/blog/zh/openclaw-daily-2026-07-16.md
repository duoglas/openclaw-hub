...
发生了什么：  
NVIDIA 发布 Nemotron Labs 文章，强调开放模型可让企业和国家拥有更高的可控性、可审计性和可定制性，并列举医疗、企业搜索、法律等场景的模型定制案例。
...
- 来源条目 3：NVIDIA 强调开放模型路线：企业 AI 竞争从“选模型”转向“定制系统” —— NVIDIA 发布 Nemotron Labs 文章，强调开放模型可让企业和国家拥有更高的可控性、可审计性和可定制性，并列举医疗、企业搜索、法律等场景的模型定制案例。
