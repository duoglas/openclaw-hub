---
title: "AI / 科技日报（2026-08-10）"
description: "2026-08-10 07:30｜截至发稿可核验信息；Firebird 在亚美尼亚启用大型 AI 工厂，采用 NVIDIA 加速计算与 Dell AI 基础设施。"
pubDate: 2026-08-10
...
- 来源条目 1：NVIDIA 支持的 Firebird 在亚美尼亚启动 CIS 区域最大 AI Factory —— Firebird 在亚美尼亚启用大型 AI 工厂，采用 NVIDIA 加速计算与 Dell AI 基础设施。计划到 2027 年底部署超过 70,000 块 NVIDIA Rubin / Blackwell GPU，并建设 300MW AI 基础设施容量。
- 来源条目 2：Open Secure AI Alliance 推出 SAFE 草案，聚焦 AI 安全事件共享 —— Open Secure AI Alliance 成员提出 Shared AI Findings Exchange（SAFE）工作组草案，希望建立 AI 安全事件、近失事件的保密共享与复盘机制。Linux Foundation 已开放 RFC。
- 来源条目 3：OpenAI GPT-5.6 系列已在 Amazon Bedrock 上进入 GA —— Amazon 公告称，OpenAI GPT-5.6 Sol、Terra、Luna 已在 Amazon Bedrock 上正式可用。主打企业安全、区域内数据处理、硬件级隔离，以及 Prompt 缓存 90% 缓存输入折扣。
- 来源条目 4：Anthropic 恢复 Claude Fable 5 全球访问，并强化网络安全防护 —— Anthropic 公告称 Claude Fable 5 和 Mythos 5 此前曾因美国出口管制与网络安全绕过问题被暂停或限制，Claude Fable 5 于 7 月 1 日全球回归。Anthropic 表示已训练新的网络安全分类器，并围绕 jailbreak 严重度评分框架强化拦截。
- 来源条目 5：中国 AI 视频大模型融资和商业化继续升温 —— 新华网报道，近三个月，可灵 AI、生数科技、爱诗科技、演语科技等中国 AI 视频公司披露新增融资合计接近 300 亿元人民币。报道还提到，可灵 AI 全球用户数突破 1 亿，AI 短剧、广告、电商内容等场景正在加速落地。
