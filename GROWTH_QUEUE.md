...
## Done
- [x] P2 Candidate B: 新增站点级 hreflang 完整性闸门（覆盖 dist/en|zh 全站 HTML 的 en/zh/x-default 绝对 URL 与互链一致性）并接入 CI；补齐 BaseLayout 全站 alternate 对向链接默认值 | ICE 9x8x8=576 — commit `PENDING`
