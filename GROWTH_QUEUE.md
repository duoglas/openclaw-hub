...
## Backlog
- [ ] P2 Candidate B / EXP-073: 强化 2026-03-27 双语 AI/Tech Daily 的搜索摘要与转化内链（重写 EN/ZH description，并把 CTA 升级为强相关内链），补齐“中国 Token 调用量放量 + 网页 Agent 开源化”主题页的可检索摘要与行动路径 | ICE 8x7x7=392
