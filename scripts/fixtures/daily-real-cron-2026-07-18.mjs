...
export const expectedSignals = [
  ...
  { title: 'Kimi 发布 K3：2.8 万亿参数、百万 token 上下文', sourceProjectionRuleMatches: ['alibaba-qoder-agentic-coding-platform-2026'], enLabel: 'China / Kimi K3 / long-context open model', zhEvidence: '来源条目 2：Kimi 发布 K3：2.8 万亿参数、百万 token 上下文', requiredTokens: ['Kimi K3', '2.8T', '100 万 token', 'Kimi Code', '2026-07-27'] },
  ...
  { title: 'WAIC 2026 开幕：产业发展、人才生态、算力成为高频主题', sourceProjectionRuleMatches: ['china-ai-industry-report-l3'], enLabel: 'China / WAIC / industry talent compute agenda', zhEvidence: '来源条目 4：WAIC 2026 开幕：产业发展、人才生态、算力成为高频主题', requiredTokens: ['2026 世界人工智能大会', '172 场会议', '产业发展', '人才生态', '算力'] },
