...
export const bannedFallbackPhrases = [
  ...
  'Cadence, Dassault Systèmes, Siemens, Synopsys',
  'NemoClaw / OpenShell',
  'CAD operations, mesh generation, simulation setup',
...
export const requiredEnglishOutputs = [
  ...
  'Evidence item 3: NVIDIA / Nemotron 3 Ultra / LangChain Deep Agents — NVIDIA said Nemotron 3 Ultra reached leading open-model performance in the LangChain Deep Agents harness',
