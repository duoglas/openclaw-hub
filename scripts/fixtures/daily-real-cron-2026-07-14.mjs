...
export const expectedSignals = [
  ...
  { title: 'WAIC 将首发超 300 款 AI 新品，中国 AI 应用规模继续扩张', sourceProjectionRuleMatches: ['china-ai-industry-report-l3'], enLabel: 'China / WAIC / AI product launch pipeline', zhEvidence: '来源条目 4：WAIC 将首发超 300 款 AI 新品，中国 AI 应用规模继续扩张', requiredTokens: ['10 万平方米', '1100 余家', '超 300 款', '2025 年已破万亿元'] },
