...
export const expectedSignals = [
  { title: 'AWS 推出一组面向企业 AI Agent 的新能力', sourceProjectionRuleMatches: ['aws-agent-continuum-enterprise-agentcore-2026'], enLabel: 'AWS / Agent / Continuum / agent platform', zhEvidence: '来源条目 1：AWS 推出一组面向企业 AI Agent 的新能力', requiredTokens: ['AWS Continuum', 'AWS Context', 'Amazon Quick', 'Bedrock AgentCore'] },
  { title: 'Anthropic 在首尔开设办公室，并扩大韩国 AI 生态合作', sourceProjectionRuleMatches: ['anthropic-korea-seoul-office-ecosystem-2026'], enLabel: 'Korea / Anthropic / NAVER / model capability update', zhEvidence: '来源条目 2：Anthropic 在首尔开设办公室，并扩大韩国 AI 生态合作', requiredTokens: ['Anthropic', 'Seoul office', 'NAVER', 'Nexon'] },
...
export const requiredEnglishOutputs = [
  ...
  'Evidence item 2: Korea / Anthropic / NAVER / model capability update',
