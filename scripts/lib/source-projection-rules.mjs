  ...
  },
  {
    ...
    capacityPlan: {
      ...
      budgetImpact: {
        ...
        categoryBudget: 6,
        categoryHeadroom: 1,
        rationale: 'capacity delta +1; raises vertical-workflow-agents for the 2026-07-01 AWS FDE production-agent deployment signal and keeps the latest daily in field-level projection.',
      },
    },
