export const FIELD_PROJECTION_RULES = [
  ...
  },
  {
    ...
    capacityPlan: {
      selectedSplitTarget: 'cloud-training-runtime-infrastructure',
  ...
  },
  {
    ...
    capacityPlan: {
      ...
      whyNotAlternatives: 'Rejected alternate split targets enterprise-agent-platforms because OpenAI Presence and Partner Network are governed deployment platform surfaces, not a generic enterprise-agent platform bucket, vertical workflow, or training-only enablement program.',
  ...
  },
  {
    ...
    owner: 'daily-source-projection',
    category: 'cloud-infrastructure',
    splitTargetCategory: 'hpc-science-compute-infrastructure',
    ...
    capacityPlan: {
      ...
      budgetImpact: {
        ...
        categoryBudget: 4,
        categoryHeadroom: 2,
        rationale: 'capacity delta 0; hpc-science-compute-infrastructure now has two effective headroom slots for future TOP500/Green500, AI-for-Science, simulation, and GPU-native scientific-compute infrastructure signals.',
      },
    },
...

  {
    ...
    capacityPlan: {
      ...
      budgetImpact: {
        ...
        categoryBudget: 7,
        categoryHeadroom: 2,
        rationale: 'capacity delta 0; uses refreshed vertical-workflow-agents capacity for the 2026-07-01 latest-fixture research-workflow signal and prevents generic latest daily fallback.',
      },
    },
  ...
  },
  {
    ...
    capacityPlan: {
      ...
      budgetImpact: {
        ...
        categoryBudget: 4,
        categoryHeadroom: 2,
        rationale: 'capacity delta 0; hpc-science-compute-infrastructure now has two effective headroom slots for future AI-for-Science HPC software, simulation, experimental-data, and GPU-native research infrastructure signals.',
      },
    },
  ...
  },
  {
    ...
    capacityPlan: {
      ...
      budgetImpact: {
        ...
        categoryBudget: 7,
        categoryHeadroom: 2,
        rationale: 'capacity delta 0; uses refreshed vertical-workflow-agents capacity for the 2026-07-01 AWS FDE production-agent deployment signal and keeps the latest daily in field-level projection.',
      },
    },
...

  {
    ...
    owner: 'daily-source-projection',
    category: 'market-intelligence',
    splitTargetCategory: 'token-economics-optimization',
...

  {
    ...
    owner: 'daily-source-projection',
    category: 'policy-governance',
    splitTargetCategory: 'aerospace-compute-infrastructure',
    displayLabels: [
      {
