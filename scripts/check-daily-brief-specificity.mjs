...
const namedEntitySource = '\\b(NVIDIA|OpenAI|Anthropic|Claude|KPMG|Amazon|AWS|Codex|ChatGPT|Google|Microsoft|Meta|Apple|Baidu|Alibaba|Tencent|Huawei|China Mobile|Gemini|DeepSeek|Mistral|Perplexity|xAI|Thomson Reuters|Thomson|CoCounsel|GTC|COMPUTEX|Vera|Rubin|Jetson|Alexa|Xinhua|Hangzhou|HBM|DRAM|NAND|Greater Bay Area|Shenzhen|University of North Carolina|UNC|China|Chinese|Europe|EU|United States|US|Japan|Korea|France)\\b';
