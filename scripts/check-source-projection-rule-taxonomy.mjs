...
export const SOURCE_PROJECTION_EFFECTIVE_CATEGORY_RULE_BUDGETS = {
  ...
  'frontier-models': 6,
  'frontier-model-cloud-distribution': 3,
  'frontier-model-inference-architecture': 4,
  'open-model-long-context': 3,
...
export const SOURCE_PROJECTION_CATEGORY_SPLIT_MIGRATION_HINTS = {
  ...
  'frontier-models': [
    {
      target: 'open-model-long-context',
      match: ['kimi-k3', 'million-token', '100 万 token', '百万 token', '2.8t'],
    },
    {
  ...
  'developer-tools': [
    {
      target: 'china-code-agent-runtime',
      match: ['qoder', 'quest-mode', 'repository-scale', '代码库理解', '异步任务委托'],
    },
    {
  ...
  'market-intelligence': [
    {
      target: 'local-commerce-ai-workflows',
      match: ['meituan', 'longcat', 'aigc-poster', 'local-commerce-ai', '美团', '本地生活', '海报生成'],
    },
    {
    ...
    {
      target: 'regional-research-ecosystems',
      match: ['canada', 'amii', 'mila', 'vector-institute', 'research-ecosystem', '1000 万加元'],
    },
    {
      target: 'regional-office-expansion',
      match: ['korea', 'seoul', 'naver', 'nexon', 'office-expansion', '首尔办公室'],
    },
    {
      target: 'workforce-ai-enablement',
      match: ['raise-us', 'future-ready-2030', 'workforce', 'training', 'ai-skills'],
    },
    {
      target: 'regional-ai-ecosystems',
      match: ['shanghai-tech-fair', 'regional', 'ecosystem'],
    },
  ],
  'physical-ai-robotics': [
    {
...
function validateSelfTests() {
  ...
  for (const fragment of [
    ...
    'split target categories: 50/50 used, missingHints=0, staleHints=0, unknown=0, unusedAllowed=0, duplicate=0',
    'existing rule split target coverage: 0/3 covered, missing=3, invalid=0, mismatched=0',
    'proposed rule split target scaffold: cloud-infrastructure -> cloud-model-distribution / cloud-agent-runtime-infrastructure / cloud-training-runtime-infrastructure / edge-hybrid-compute-infrastructure / hpc-science-compute-infrastructure; company-finance -> ai-lab-private-financing / public-market-readiness / robotics-capital-markets; consumer-productivity -> career-productivity-workflows / chatgpt-control-surfaces / consumer-creative-ai / consumer-agentic-product-surfaces; developer-tools -> china-code-agent-runtime / code-agent-runtime / desktop-computer-use / domestic-compute-software; enterprise-agents -> enterprise-agent-platforms / governed-agent-deployment-platforms / vertical-workflow-agents / agent-enablement-programs; frontier-models -> frontier-model-task-capability / frontier-model-cloud-distribution / frontier-model-inference-architecture / open-model-long-context; market-intelligence -> market-sizing-reports / supply-chain-cost-pressure / token-economics-optimization / waic-product-launch-pipeline / waic-industry-agenda / ai-commercialization-roi / local-commerce-ai-workflows / content-licensing-markets / regional-ai-ecosystems / regional-office-expansion / regional-research-ecosystems / workforce-ai-enablement; physical-ai-robotics -> robotics-simulation-training / robotics-commercial-deployment / autonomous-mobility-systems / assistive-exoskeleton-robotics / humanoid-embodied-training / robotics-open-model-research; policy-governance -> ai-policy-standards / ai-industrial-policy / aerospace-compute-infrastructure / digital-regulation-compliance; product-safety -> high-sensitivity-ai-deployment / agent-runtime-safety / model-account-security / youth-safety-controls',
  ...
  for (const fragment of [
    ...
    'category split recommendations: developer-tools: split into china-code-agent-runtime / code-agent-runtime / desktop-computer-use / domestic-compute-software (100% used + 0 headroom); company-finance: split into ai-lab-private-financing / public-market-readiness / robotics-capital-markets (80% used + 1 headroom)',
